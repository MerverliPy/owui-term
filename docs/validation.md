...
### Public traction
- **Published 2026-08-21:** `v0.1.0` tagged on [MerverliPy/owui-term](https://github.com/MerverliPy/owui-term); repo made **public** the same day. **D8c 30-day traction window is OPEN — closes ~2026-09-20**; signal recorded back here.
