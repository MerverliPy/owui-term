...
Client behavior on unsupported versions: clear "unsupported Open-WebUI version" notice + best-effort completions-only mode (D5), never silent failure. *(Planned — no API client in Phase 2; lands with the client in Phase 3.)*
